...
export const App = () => (
  <Canvas flat camera={{ fov: 75, position: [0, 0, 20] }} eventSource={document.getElementById('root')} eventPrefix="client">
    ...
    <Frame id="01" name="ThreeJs" author="Sergey Belyakov" bg="#e4cdac" position={[-1.15, 0, 0]} rotation={[0, 0.5, 0]}>
      {/* <Gltf src="fiesta_tea-transformed.glb" scale={8} position={[0, -0.7, -2]} /> */}
    </Frame>
    <Frame id="02" name="Portfolio" author="Sergey Belyakov" bg="#d1d1ca">
      {/* <Gltf src="fiesta_tea-transformed.glb" position={[0, -2, -3]} /> */}
    </Frame>
    <Frame id="03" name="R3F" author="Sergey Belyakov" bg="#e4cdac" position={[1.15, 0, 0]} rotation={[0, -0.5, 0]}>
      {/* <Gltf src="fiesta_tea-transformed.glb" scale={2} position={[0, -0.8, -4]} /> */}
    </Frame>
    <Rig />
    <Preload all />
  </Canvas>
